...
// Get all technicians (Supervisor/Planner/Admin only)
router.get('/', authenticate, authorize('supervisor', 'planner', 'admin'), async (req, res) => {
  try {
...
router.get('/:id', authenticate, async (req, res) => {
  try {
    ...
    // Technicians can only view their own profile unless supervisor/planner/admin
    if (req.user.role === 'technician' && req.user.id !== technician._id.toString()) {
