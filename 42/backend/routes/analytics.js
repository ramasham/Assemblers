...
router.get('/overview', authenticate, authorize('supervisor', 'planner', 'admin'), async (req, res) => {
  try {
...
router.get('/technician-performance', authenticate, authorize('supervisor', 'planner', 'admin'), async (req, res) => {
  try {
...
router.get('/job-progress', authenticate, authorize('supervisor', 'planner', 'admin'), async (req, res) => {
  try {
...
router.get('/productivity-trends', authenticate, authorize('supervisor', 'planner', 'admin'), async (req, res) => {
  try {
